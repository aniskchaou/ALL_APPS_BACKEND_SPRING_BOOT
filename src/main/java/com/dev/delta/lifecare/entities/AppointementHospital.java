...
public class AppointementHospital {
	...
	String   problem;
	String   status;
	public AppointementHospital(String departement_id, String patient_id, String doctor_id, String date, String problem,
			String status) {
		super();
