...
@Entity
@Table(name="pharmalife_buy")
public class BuyPharma {
	...
	public BuyPharma(String manufacturer_id, String purchase_date, String chalan_no, String purchase_details, String paytype,
			String bank_id) {
		super();
